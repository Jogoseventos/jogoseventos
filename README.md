...
<style>
  ...
  * { margin:0; padding:0; box-sizing:border-box; font-family: Arial, sans-serif; }
  ...
  /* BUTTONS */
  .btn { padding:12px 30px; border:none; border-radius:5px; cursor:pointer; font-size:1rem; transition:0.3s; background:linear-gradient(45deg,#ff3c00,#ff8a00); background-size:200% 200%; animation:gradientShift 3s ease infinite; }
  ...
  .ticket-card { background:#1c1c1c; padding:20px; border-radius:10px; border:2px solid transparent; transition:0.3s; cursor:pointer; }
  .ticket-card:hover { transform:translateY(-10px); border:2px solid #ff3c00; box-shadow:0 10px 20px rgba(255,60,0,0.5); }
  .ticket-card h3 { margin-bottom:10px; color:#ff3c00; }
  .ticket-card p { margin-bottom:15px; }
  .ticket-card a { display:inline-block; background:#ff6600; padding:10px 20px; border-radius:5px; color:#fff; transition:0.3s; }
...
<!-- HERO -->
<section class="hero">
  <!-- Substitua "IMAGEM-HERO.jpg" por vídeo se quiser -->
  <img src="IMAGEM-HERO.jpg" alt="Banner">
